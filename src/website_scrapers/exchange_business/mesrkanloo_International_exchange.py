...
def get_rates_from_mesrkanloo_international() -> CompanyExchangeRates | None:
    headers = {
        'referer': 'https://mesrkanlooexchange.com'
    }

    html_page = make_get_request_with_parsed_html(ExchangeBusinessApiUrl.MESRKANLOO_INTERNATIONAL_EXCHANGE,
...
def scrape_mesrkanloo_international_exchange() -> ExchangeCompany | None:
    try:
        company_exchange_rates = get_rates_from_mesrkanloo_international()
        if (company_exchange_rates is None):
            return None
        exchange_company = ExchangeCompany(ExchangeBusinessNames.MESRKANLOO_INTERNATIONAL_EXCHANGE,
                                           ExchangeBusinessUrl.MESRKANLOO_INTERNATIONAL_EXCHANGE,
