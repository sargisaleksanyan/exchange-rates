from src.website_scrapers.banks.Invest_bank import scrape_invest_bank
from src.website_scrapers.banks.abu_dhabi_commercial_bank import scrape_abu_dhabi_commercial_bank
from src.website_scrapers.banks.abu_dhabi_islamic_bank import scrape_abu_dhabi_islamic_bank
from src.website_scrapers.banks.ajmanbank import scrape_ajman_bank
from src.website_scrapers.banks.bank_of_barodauae import scrape_bank_of_barodauae
from src.website_scrapers.banks.bank_of_sharjah import scrape_bank_of_sharjah
...
from src.website_scrapers.banks.national_bank_of_umm_al_qaiwain import scrape_national_bank_of_umm_al_qaiwain
from src.website_scrapers.banks.sharjah_islamic_bank import scrape_sharjah_islamic_bank

very_rear_banks_update = [scrape_sharjah_islamic_bank ]

non_frequent_banks_update = [scrape_abu_dhabi_commercial_bank, scrape_commercial_bank_of_dubai, scrape_ajman_bank,scrape_bank_of_barodauae,
...
frequent_banks_update = [scrape_first_abu_dhabi_bank_data, scrape_emiratesnbd_bank_data,
                         ...
                         # scrape_bank_of_sharjah blocks requests.
                         ]
