...
non_frequent_banks_update = [scrape_abu_dhabi_commercial_bank,scrape_commercial_bank_of_dubai]
...
frequent_banks_update = [scrape_first_abu_dhabi_bank_data, scrape_emiratesnbd_bank_data,
                         ...
                         scrape_emirates_islamic_bank_data,scrape_sharjah_islamic_bank]
